    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@androidx.annotation.NonNull MenuItem menuItem) {
                ...
                if (id == R.id.bt1) {
                    Intent intent = new Intent(studentscore.this, studreg.class);
                    startActivity(intent);
                } else if (id == R.id.bt2) {
                    Intent intent = new Intent(studentscore.this, adminchanpas.class);
                    startActivity(intent);
                }  else if (id == R.id.bt3) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(studentscore.this);
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(studentscore.this, home.class);
                            startActivity(intent);
